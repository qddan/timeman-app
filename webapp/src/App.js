...
function App() {
  ...
  return (
    <Div d="flex" align="center" flexDir="column" p="2rem" className="App">
      <Text textSize="heading">Timeman for me 🕰</Text>
      <Text textSize="subheader">Never miss an attendance again!</Text>
      {!webhook ? (
        <>
          <Div m="2rem" p="1rem" rounded="lg" shadow="3">
            <Text>
              1. Generate a webhook: Go to Bitrix / Applications / Webhooks /
              Add Inbound Webhook / Select <code>Users (user)</code> and{' '}
              <code>Working Time Management (timeman)</code>.
            </Text>
            <Text>
              2. Copy webhook URL, it should looks like this:{' '}
              <code>https://BITRIX_URL/rest/1/WEBHOOK_TOKEN</code> and paste to
              input below.
            </Text>
          </Div>
          <Input
        ...
        <>
          <Div m="2rem" p="1rem" rounded="lg" shadow="3">
            <Text>
              Your current webhook: <code>{webhook}</code>.
            </Text>
          </Div>
          <Div d="flex" p="2rem">
            <Button
        ...
        <>
          <Div m="2rem" p="1rem" rounded="lg" shadow="3" d="flex">
            <Image
            ...
            <Div m={{ l: '1rem' }}>
              <Text>
                Schedule set for <b>{currentUser.EMAIL}</b>
              </Text>
              {userStatus && (
                <Div d="flex">
